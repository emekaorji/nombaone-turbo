 ...
 * colour is driven by the parent's `text-*` class — pass `text-purple-50` for the
 * light-on-purple variant. Inline (no `<Image>`): no network round-trip, no
 * aspect-ratio warning, no flash on first paint, and the glyph ships in the
 * bundle. Geometry mirrors `public/brand/logo-icon-*.svg`.
 */
