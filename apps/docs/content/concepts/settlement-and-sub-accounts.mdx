...
description: How a verified collection splits into the platform fee and the merchant's net, settles to their Nomba sub-account, and stays claw-back-safe with an escrow lock.
---
