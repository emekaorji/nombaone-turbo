---
title: Environments
description: nombaone has two environments — test and live. Your secret key's prefix pins every request to exactly one of them.
...
<Callout type="note" title="Resources carry their environment">
...
<Callout type="warning" title="Promote deliberately">
