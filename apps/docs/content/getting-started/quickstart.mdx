---
title: Quickstart
description: Get a sandbox secret key and make your first authenticated call to the nombaone API.
section: get-started
---
...
<Steps>
  <Step title="Create an organization and get a sandbox key">
