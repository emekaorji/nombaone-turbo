...
description: "Reach a real 201 with Ruby: create your first plan on the Nomba One sandbox in a few lines."
section: get-started
---
...
<Snippet method="POST" path="/v1/plans" body={{ name: "Pro" }} idempotent defaultLang="ruby" />
