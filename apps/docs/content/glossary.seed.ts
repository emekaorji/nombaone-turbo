...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  { term: "price", definition: "A recurring amount + cadence on a plan (e.g. ₦5,000 / month). A price is never rewritten: changing the amount mints a new price and deactivates the old one, so subscribers keep the price they signed up on.", schemaRef: "PriceResponseData" },
  { term: "cadence", definition: "How often a price bills: a unit (minute, day, week, month, year) times a count. A month with a count of 3 is quarterly; a minute with a count of 10 is every ten minutes.", conceptSlug: "/guides/create-plans-and-prices" },
