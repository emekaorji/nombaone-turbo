...
description: Two ways to reduce what a customer pays — a coupon discounts an invoice by a percentage or a fixed amount, a credit grant is a balance that draws down first.
section: guides
order: 7
---
...
<Callout type="tip" title="They stack in a defined order">
...
<CardGroup cols={2}>
  <Card title="The ledger" href="/concepts/the-ledger">
