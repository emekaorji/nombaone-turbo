---
title: Going live
description: The checklist to move from a test key to real money — swap the key and host, re-register webhooks, verify signatures live, and confirm idempotency and the money unit before the first charge.
section: guides
order: 8
---
