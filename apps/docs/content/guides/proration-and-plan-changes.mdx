...
description: "Upgrade, downgrade, or switch intervals mid-cycle: one call, with proration computed as balanced ledger legs so the customer is charged exactly the difference."
section: guides
order: 6
---
...
<Callout type="note" title="Quantity changes prorate too">
...
<Callout type="tip" title="Schedule a change for the next renewal">
...
<CardGroup cols={2}>
  <Card title="Why proration is a ledger problem" href="/concepts/hard-parts/proration-is-a-ledger-problem">
    How fractional kobo resolve so the legs always balance.
  </Card>
  <Card title="Create plans and prices" href="/guides/create-plans-and-prices">
