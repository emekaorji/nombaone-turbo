...
export const MANIFEST: ManifestSection[] = [
  ...
  },
  {
    ...
    mode: "reference",
    items: [
      { slug: "/sdks", title: "Overview", summary: "The nine official SDKs and the CLI, side by side: pick your language and install." },
      {
        slug: "/sdks/node",
        title: "Node.js & TypeScript",
        summary: "The @nombaone/node SDK: one library for Node, Next.js, and every JS runtime.",
        children: [{ slug: "/sdks/node/reference", title: "Method reference" }],
      },
      {
        slug: "/sdks/python",
        title: "Python",
        summary: "The nombaone SDK for Python, with sync and async clients.",
        children: [{ slug: "/sdks/python/reference", title: "Method reference" }],
      },
      {
        slug: "/sdks/go",
        title: "Go",
        summary: "The nombaone-go SDK: context-first, zero dependencies.",
        children: [{ slug: "/sdks/go/reference", title: "Method reference" }],
      },
      {
        slug: "/sdks/php",
        title: "PHP",
        summary: "The nombaone/nombaone-php SDK for PHP, Laravel, and Symfony.",
        children: [{ slug: "/sdks/php/reference", title: "Method reference" }],
      },
      {
        slug: "/sdks/ruby",
        title: "Ruby",
        summary: "The nombaone gem for Ruby and Rails, with zero runtime dependencies.",
        children: [{ slug: "/sdks/ruby/reference", title: "Method reference" }],
      },
      {
        slug: "/sdks/java",
        title: "Java",
        summary: "The xyz.nombaone:nombaone SDK for Java, Kotlin, and Spring.",
        children: [{ slug: "/sdks/java/reference", title: "Method reference" }],
      },
      {
        slug: "/sdks/dotnet",
        title: ".NET",
        summary: "The NombaOne SDK for C# and .NET, async from top to bottom.",
        children: [{ slug: "/sdks/dotnet/reference", title: "Method reference" }],
      },
      {
        slug: "/sdks/rust",
        title: "Rust",
        summary: "The nombaone crate: async-first on tokio, with an optional blocking API.",
        children: [{ slug: "/sdks/rust/reference", title: "Method reference" }],
      },
      {
        slug: "/sdks/elixir",
        title: "Elixir",
        summary: "The nombaone Hex package for Elixir and Phoenix.",
        children: [{ slug: "/sdks/elixir/reference", title: "Method reference" }],
      },
      { slug: "/sdks/cli", title: "CLI", summary: "The nombaone command-line tool: tail webhooks and scaffold locally." },
    ],
  },
  {
    title: "Guides",
