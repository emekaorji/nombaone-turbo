...
description: "Decide what your customer sees when a payment fails: the retry schedule and the message that recovers the payment without you chasing it."
section: merchants
order: 4
---
...
<Callout type="warning" title="Don't cut off the customer at the first failure">
...
<Callout type="note" title="The card re-confirm case">
