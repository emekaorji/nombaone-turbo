...
description: Map Flutterwave's tx_ref / flw_ref split and payment-plan model to Nomba One's one-reference, integer-kobo equivalents.
section: migrate
order: 4
---
...
<Callout type="tip" title="Bank transfer is first-class, not a workaround">
