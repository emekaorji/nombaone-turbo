...
description: Coming from another processor? Map what you already know to Nomba One's cleaner equivalents, and move without downtime by running both in parallel.
section: migrate
order: 1
---
...
<CardGroup cols={2}>
  <Card title="Coming from Paystack" href="/migrate/from-paystack">
    Map Paystack's subscription gotchas to our clean equivalents.
  </Card>
  <Card title="Coming from Stripe Billing" href="/migrate/from-stripe">
    Move a Stripe Billing integration, concept by concept.
  </Card>
  <Card title="Coming from Flutterwave" href="/migrate/from-flutterwave">
    Untangle tx_ref / flw_ref into one reference.
  </Card>
  <Card title="From any processor" href="/migrate/generic">
...
<Callout type="tip" title="Move without a big-bang cutover">
