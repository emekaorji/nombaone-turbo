---
title: Go SDK
description: "The nombaone-go SDK: one context-first, zero-dependency Go library for the NombaOne billing API — typed errors you match with errors.As, retries that never double-charge, range-over-func pagination, and a standalone webhook package."
section: sdks
---
...
<Callout type="warning" title="Rehearse declines with a trial, not a live first charge">
...
<CardGroup cols={3}>
  <Card title="Method reference" href="/sdks/go/reference">
