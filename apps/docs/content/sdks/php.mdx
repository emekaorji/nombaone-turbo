---
title: PHP SDK
description: "The nombaone/nombaone-php SDK: one library for PHP, Laravel, and Symfony. Associative arrays in, typed readonly objects out, with typed exceptions, automatic retries that never double-charge, cursor pagination, and a keyless webhook verifier."
section: sdks
---
...
<Callout type="warning" title="The machine error code is $errorCode, not $code">
...
<CardGroup cols={3}>
  <Card title="Method reference" href="/sdks/php/reference">
