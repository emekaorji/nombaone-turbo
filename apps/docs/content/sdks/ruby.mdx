---
title: Ruby SDK
description: "The nombaone gem: one library for Ruby and Rails with zero runtime dependencies. Typed errors you rescue, automatic retries that never double-charge, Enumerable pagination, and a keyless webhook verifier."
section: sdks
---
...
<Callout type="warning" title="Webhook signature verification is not live yet">
...
<CardGroup cols={3}>
  <Card title="Method reference" href="/sdks/ruby/reference">
