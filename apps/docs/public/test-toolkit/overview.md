...
type: reference
summary: "Drive the engine deterministically on the sandbox — deterministic payment outcomes, a test clock to skip the wait, and on-demand signed webhooks. No real card, no cron."
canonical: https://docs.nombaone.xyz/test-toolkit/overview
---
...
> **Test-deployment only, live behavior identical**
>
