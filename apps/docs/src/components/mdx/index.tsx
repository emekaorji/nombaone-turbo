...
export const mdxComponents: MDXComponents = {
  ...
  p: (props: HTMLAttributes<HTMLParagraphElement>) => (
    <p className="mt-4 text-[16px] leading-7 text-foreground/85" {...props} />
  ),
  a: Anchor,
  ...
  ul: (props: HTMLAttributes<HTMLUListElement>) => (
    <ul className="mt-4 list-disc space-y-2 pl-6 text-[16px] leading-7 text-foreground/85 marker:text-accent" {...props} />
  ),
  ol: (props: HTMLAttributes<HTMLOListElement>) => (
    <ol className="mt-4 list-decimal space-y-2 pl-6 text-[16px] leading-7 text-foreground/85 marker:text-muted-foreground" {...props} />
  ),
  li: (props: HTMLAttributes<HTMLLIElement>) => <li className="pl-1" {...props} />,
  blockquote: (props: HTMLAttributes<HTMLQuoteElement>) => (
    <blockquote
      className="mt-6 border-l-2 border-accent-border bg-muted/40 py-2 pl-4 pr-2 text-[16px] italic leading-7 text-muted-foreground"
      {...props}
    />
  ),
