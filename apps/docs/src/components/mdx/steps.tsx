  ...
  return (
    <div className="relative flex gap-4 pb-6 last:pb-0">
      <div className="flex flex-col items-center">
        <span className="z-10 grid size-7 shrink-0 place-items-center rounded-full border border-accent-border bg-accent-muted font-mono text-xs font-semibold text-accent dark:border-accent-border dark:bg-accent-muted dark:text-accent">
          {index}
        </span>
