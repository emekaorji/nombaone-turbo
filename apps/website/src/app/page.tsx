...
export default function HomePage() {
  return (
    <>
          ...
          <div className="relative flex flex-col gap-9 rounded-[20px] bg-surface-1 p-8 md:p-14">
            ...
            <div className="flex flex-col gap-[18px]">
              ...
              <p className="max-w-[740px] text-lg leading-[1.55] text-muted-foreground md:text-[22px]">
                Nomba One runs on Nomba, the licensed payment infrastructure hundreds of thousands
                of Nigerian businesses already trust to move money. We run the subscriptions; Nomba
                moves the naira.
              </p>
            </div>
      ...
      {/* §06 Simulator (T6mX2) */}
      {/* this did not work as it should have. come back to it later. */}
      ...
      <HomeSection id="hard-parts">
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-4 gap-y-[18px] rounded-[14px] border border-border bg-surface-1 p-8 sm:grid-cols-2 lg:grid-cols-3">
          {GUARANTEES.map((g) => (
...
function cnRow(i: number) {
  return i === 0 ? 'flex items-center py-2.5' : 'flex items-center border-t border-border py-2.5';
}
