 ...
 * These bodies drive the `/v1/sandbox/*` endpoints that ONLY exist on a test
...
/** POST /v1/sandbox/payment-methods — mint a ready, deterministic test payment method. */
...
/** POST /v1/sandbox/webhooks/simulate — emit + deliver a real catalog event on demand. */
