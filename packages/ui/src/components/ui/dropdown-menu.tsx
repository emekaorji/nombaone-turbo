...
/**
 * Default focus background is `bg-muted` (neutral). The magenta `bg-accent`
 * tint is reserved for `variant="destructive"` items only — Nombaone’s
 * convention is to surface the brand-secondary accent only on dangerous
 * actions so it functions as a warning, not as decoration.
 */
...
>(({ className, inset, variant = "default", ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "data-[variant=destructive]:focus:bg-accent data-[variant=destructive]:focus:text-accent-foreground",
      inset && "pl-8",
      className
    )}
    {...props}
