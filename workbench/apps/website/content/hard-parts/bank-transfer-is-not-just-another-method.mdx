...
slug: bank-transfer-is-not-just-another-method
problem: "You can charge a card. You cannot charge a bank transfer. The whole billing model changes."
...
[Open the simulator](/product#simulator) and [read the reconciliation docs](/docs/reconciliation).
