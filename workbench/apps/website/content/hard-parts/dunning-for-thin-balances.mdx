...
slug: dunning-for-thin-balances
problem: "Most subscription churn in Nigeria is involuntary. A retry on the wrong day just burns an attempt."
group: billing-mechanics
difficulty: intermediate
readingTime: 5
simulator: insufficient_funds
updated: 2026-07-03
---
...
[Open the simulator](/product#simulator) and [read the dunning docs](/docs/dunning).
